...
namespace Cineworld
{
    ...
    public class BookingHistory
    {
        ...
        {
			if (CineworldApplication.MobileService == null)
				CineworldApplication.MobileService = new MobileServiceClient("https://cineworld.azure-mobile.net/", "kpNUhnZFTNayzvLPaWxszNbpuBJnNQ87");
