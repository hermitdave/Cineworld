...
namespace CineworldiPhone
{
	public partial class Cineworld_iPhoneViewController : UIViewController
	{
		...
		public async override void ViewDidLoad ()
		{
			...
			Application.AvailableImageDefault = ImageHelper.ImageFromColor (UIColor.White, size);
			Application.AvailableImagePressed = ImageHelper.ImageFromColor (UIColor.FromRGB (0, 122, 255), size);
			...
			appDelegate.Window.RootViewController.View.AddSubview (new ADBannerView (new CGRect (0, this.View.Bounds.Height-50, 320, 50)) );
			...
			{
				UIAlertView alert = new UIAlertView ("CineFilms for Cineworld", "Error downloading data. Please try again later", null, "OK", null);
				alert.Show();
			}
			finally
			{
